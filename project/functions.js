...
function createUser(req, res, user, usersdb) {
    ...
    console.log(user);
    try {
	usersdb.insert({username: user['username'], firstName: user['firstName'], lastName: user['lastName'], pwd: user['password'], friends: [ ], requests: [ ]});
