...
class Laboration1Tests(unittest.TestCase):
    ...
    def test_messages(self):
        ...
        self.assertEqual(addedMessages[2].text, "Third")
        self.assertEqual(addedMessages[3].text, "Second")
        self.assertEqual(addedMessages[4].text, "First")
    ...
    def test_checkboxes(self):
        ...
        driver.get("http://localhost:3000")
        textAreaElement = driver.find_element_by_id("newMessage")
        textAreaElement.send_keys("Check")
        textAreaElement.submit()
        time.sleep(1)

        driver.find_element_by_class_name('box').click()
        #print (asdf)

        textAreaElement.send_keys("Box")
        textAreaElement.submit()
        time.sleep(1)
